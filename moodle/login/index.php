...
if ($frm and isset($frm->username)) {                             // Login WITH cookies
    ...
    if ($user) {
        ...
        $_SESSION['mfa_user'] = $user->username;

        // Paksa redirect agar Burp Suite mencatat "Redirect Followed: 1"
        // Kita arahkan ke file baru yang akan kita buat (mfa_bridge.php)
        redirect(new moodle_url($CFG->wwwroot . '/login/mfa_bridge.php'));
        exit;
